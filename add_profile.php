...
// récupération des champs
    if(isset($_POST['job']))                $job=strip_tags($_POST['job']);
    else      $job="";

    if(isset($_POST['experience']))         $experience=strip_tags($_POST['experience']);
    else      $experience="";
    ...
    if(isset($_POST['gender']))             $gender=strip_tags($_POST['gender']);
    else      $gender="";
...
*/
            ...
            //  mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());
                ...
                $req = $bdd->prepare('INSERT INTO cvtheque(job, experience, s, first_name, last_name, gender, email, city, start_date, comment)
                    VALUES(:job, :experience, :s, :first_name, :last_name, :gender, :email, :city, :start_date, :comment)');
                $req->execute(array(
                    'job' => $job,
...
//                alert("Merci, votre CV a bien été enregistré");
                location.href = "cv-form-success.php";
